...
export const harnessLead: HarnessLead = {
  label: 'харнес · процесс из коробки',
  headline: 'Харнес — управляющий слой над LLM-агентами',
  subhead:
    'Процесс, который не разваливается на третьей задаче: пять детерминированных стадий ' +
    'и консилиум с кросс-ревью — агент обязан показать работу, а не отчитаться «готово». ' +
    'Три сборки ядра: 01 — харнес внутри Claude Code, 02 — адаптер для CLI-агента, ' +
    '03 — универсальное ядро без привязки к инструменту. Берите готовое, меняйте под себя.',
  usageLine:
