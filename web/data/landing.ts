...
export const tryItems = [
  ...
  {
    tag: 'STYLE',
    title: 'Переписать как инсайдер',
    desc: 'Вставьте любой текст — агент сохранит ваши факты, но подаст их с позицией в первом абзаце, переводом «на человеческий» и панчем в конце. Три режима грубости. Без логина.',
    href: '/style',
    icon: 'cpu',
  },
  {
