// Dashboard (/) — server component, force-dynamic (читает live-БД каждый запрос).
//
    ...
    <div className="space-y-8">
      <section>
        ...
        <p className="mt-1 text-sm text-neutral-500">
          Состояние системы на день 28. Данные из <code className="rounded bg-neutral-200 px-1 text-xs dark:bg-neutral-800">challenge/.data</code>.
        </p>
        {keys.activeModel ? (
