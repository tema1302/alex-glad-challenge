// Публичная витрина харнес-инструкций (/harness) — раздатка: три нейтральных шаблона
// инструкций для AI-ассистентов (контракт вызова / кодекс памяти / профили и правила).
