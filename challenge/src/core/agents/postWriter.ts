...
- НЕ ОБРЕЗАЙ пост на полуслове. Если не хватает места — сократи мысль, но допиши до конца.

=== ФОРМАТИРОВАНИЕ ===
- Разбей пост на абзацы. КАЖДЫЕ 2-4 предложения — новый абзац, отделён пустой строкой.
- НЕ пиши сплошным текстом в один абзац.
- Между абзацами — пустая строка (двойной перенос \\n\\n).
